...
(function(){
  ...
  function blkHtml(p,it){
    ...
    return '<label class="noblk"><input type="checkbox" data-noblk="1" '+a+
      ...
      '寫「不會用」我沒辦法幫；寫「AI 一直說找不到我的檔案」我一看就知道問題在哪。\n'+
      '例：AI 找不到我的資料夾／差異清單有一半對不上／不知道要拿哪兩份來比／時間沒省到還變慢\n'+
  ...
  function anaHtml(p,it){
    ...
    if(n===4){
      ...
      out='<div class="anamiss"><strong>從第 01 堂就填，每週跟時間帳一起更新。</strong>照這個樣子寫（示範）：</div>'+
        ...
        '<b>因為</b> 上週三店營業額手抄進表，有 2 天的數字跟 POS 對不上，差了 1,800 元'+
        '<b>，所以</b> 對不上的都在假日，抄的時候漏了外送那一筆'+
        '<b>，本週先做</b> 先用光復店跑一週，每天比對一次'+
        '<b>，下週看</b> 對不上的天數，從 2 天降到 0 天。</div>';
    } else {
